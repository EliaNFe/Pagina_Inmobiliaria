    ...
    <div className="flex flex-col gap-3">
      ...
      {config.whatsapp && (
        <a
          ...
          className="group flex items-center justify-between bg-white/40 backdrop-blur-xl border border-white/60 rounded-2xl p-4 md:px-5 transition-all hover:-translate-y-0.5 hover:bg-white/55"
        ...
        >
          ...
          <div className="flex items-center gap-3 md:gap-4 pr-3">
            <div className="w-10 h-10 rounded-full bg-white/60 backdrop-blur-md border border-white/50 flex items-center justify-center text-green-600 shrink-0">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z" />
              </svg>
            </div>
            <div>
              <p className="font-semibold text-stone-900 text-sm">Enviar WhatsApp</p>
              {/* text-balance ayuda a que si baja de línea quede armónico */}
              <p className="text-stone-500 text-xs mt-0.5 text-balance">Respuesta rápida — lunes a sábado</p>
            </div>
          </div>

          {/* FLECHA DERECHA (aislada) */}
          <div className="shrink-0 text-stone-400 transition-transform duration-300 group-hover:translate-x-1 group-hover:text-orange-600">
      ...
      {instagramHref && (
        ...
        >
          <div className="flex items-center gap-3 md:gap-4 pr-3">
            <div className="w-10 h-10 rounded-full bg-white/60 backdrop-blur-md border border-white/50 flex items-center justify-center text-pink-600 shrink-0">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div>
              <p className="font-semibold text-stone-900 text-sm">Visitar Instagram</p>
              <p className="text-stone-500 text-xs mt-0.5 text-balance">Mirá las últimas propiedades publicadas</p>
            </div>
          </div>
          <div className="shrink-0 text-stone-400 transition-transform duration-300 group-hover:translate-x-1 group-hover:text-orange-600">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {config.email && (
        ...
        >
          <div className="flex items-center gap-3 md:gap-4 pr-3">
            <div className="w-10 h-10 rounded-full bg-white/60 backdrop-blur-md border border-white/50 flex items-center justify-center text-orange-700 shrink-0">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="break-all sm:break-normal">
              <p className="font-semibold text-stone-900 text-sm">Escribir un correo</p>
      ...
      {config.telefono && (
        ...
        >
          <div className="flex items-center gap-3 md:gap-4 pr-3">
            <div className="w-10 h-10 rounded-full bg-white/60 backdrop-blur-md border border-white/50 flex items-center justify-center text-blue-600 shrink-0">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
              </svg>
            </div>
            <div>
              <p className="font-semibold text-stone-900 text-sm">Llamar ahora</p>
          ...
          <div>
            ...
            >
              ...
              <p className="text-stone-500 text-sm leading-relaxed pl-6">{config.direccion || "Necochea, Buenos Aires"}</p>
            </div>
            <div
              className="bg-white/25 backdrop-blur-xl border border-white/50 rounded-2xl overflow-hidden"
              style={{ boxShadow: "0 8px 32px rgba(194,84,10,0.06)", height: "220px" }}
            >
              <iframe
