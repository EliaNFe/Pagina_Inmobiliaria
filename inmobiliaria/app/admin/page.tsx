      ...
      <div className="max-w-6xl mx-auto py-10 px-6">
        ...
        <div style={{display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "16px", marginBottom: "24px"}}>
          {[
            ...
            {label: "Destacadas en home", value: destacadas, color: "#C2540A"},
            ...
            <tbody>
              {listaPropiedades.map((propiedad) => (
                <tr key={propiedad.id} style={{borderTop: "1px solid #FFF7ED"}}>
                  ...
                  <td style={{padding: "14px 24px"}}>
                    {propiedad.destacada
                      ? <span style={{background: "#FFF7ED", color: "#C2540A", fontSize: "11px", fontWeight: 700, padding: "4px 10px", borderRadius: "999px"}}>Sí</span>
